      ...
      <table className="min-w-full table-auto">
        <thead>
          <tr className="bg-blue-50 text-left text-sm">
            ...
            <th className="px-2 py-4">Título</th>
            <th className="px-2 py-4">Estado</th>
            <th className="px-2 py-4">Prioridad</th>
            <th className="px-2 py-4">Fecha de creación</th>
            <th className="px-2 py-4">Fecha de actualización</th>
            <th className="px-2 py-4">Fecha de cierre</th>
        ...
        <tbody>
          {tickets.map((ticket, idx) => (
            ...
            >
              <td className="px-2 py-4 font-mono text-xs">{ticket._id}</td>
              <td className="px-2 py-4 font-medium">{ticket.tittle}</td>
              ...
              <td className="px-2 py-4">{new Date(ticket.create_at).toLocaleString()}</td>
              <td className="px-2 py-4">
                {ticket.updated_at
